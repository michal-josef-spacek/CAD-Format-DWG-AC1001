...
sub _read {
    ...
    $self->{view_point} = CAD::Format::DWG::AC1001::Point3d->new($self->{_io}, $self, $self->{_root});
    $self->{unknown_repeating} = CAD::Format::DWG::AC1001::UnknownRepeating->new($self->{_io}, $self, $self->{_root});
