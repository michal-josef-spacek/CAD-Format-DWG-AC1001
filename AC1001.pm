...
sub _read {
    ...
    $self->{header} = CAD::Format::DWG::AC1001::Header->new($self->{_io}, $self, $self->{_root});
    ...
    $self->{entities} = CAD::Format::DWG::AC1001::RealEntities->new($io__raw_entities, $self, $self->{_root});
    $self->{table_blocks} = ();
    my $n_table_blocks = $self->header()->table_block()->items();
    for (my $i = 0; $i < $n_table_blocks; $i++) {
        push @{$self->{table_blocks}}, CAD::Format::DWG::AC1001::Block->new($self->{_io}, $self, $self->{_root});
    }
    $self->{table_layers} = ();
    my $n_table_layers = $self->header()->table_layer()->items();
    for (my $i = 0; $i < $n_table_layers; $i++) {
        push @{$self->{table_layers}}, CAD::Format::DWG::AC1001::Layer->new($self->{_io}, $self, $self->{_root});
    }
    $self->{table_styles} = ();
    my $n_table_styles = $self->header()->table_style()->items();
    for (my $i = 0; $i < $n_table_styles; $i++) {
        push @{$self->{table_styles}}, CAD::Format::DWG::AC1001::Style->new($self->{_io}, $self, $self->{_root});
    }
    $self->{table_linetypes} = ();
    my $n_table_linetypes = $self->header()->table_linetype()->items();
    for (my $i = 0; $i < $n_table_linetypes; $i++) {
        push @{$self->{table_linetypes}}, CAD::Format::DWG::AC1001::Linetype->new($self->{_io}, $self, $self->{_root});
    }
    $self->{table_views} = ();
    my $n_table_views = $self->header()->table_view()->items();
    for (my $i = 0; $i < $n_table_views; $i++) {
        push @{$self->{table_views}}, CAD::Format::DWG::AC1001::View->new($self->{_io}, $self, $self->{_root});
    }
    ...
    $self->{entities_block} = CAD::Format::DWG::AC1001::RealEntities->new($io__raw_entities_block, $self, $self->{_root});
    ...
    $self->{entities_extra} = CAD::Format::DWG::AC1001::RealEntities->new($io__raw_entities_extra, $self, $self->{_root});
    if (!($self->_io()->is_eof())) {
        $self->{todo} = ();
...
########################################################################
package CAD::Format::DWG::AC1001::EntityAttrib;
...
sub _read {
    ...
    $self->{entity_mode} = CAD::Format::DWG::AC1001::EntityMode->new($self->{_io}, $self, $self->{_root});
    $self->{entity_size} = $self->{_io}->read_s2le();
    $self->{entity_layer_index} = $self->{_io}->read_s2le();
    $self->{entity_common} = CAD::Format::DWG::AC1001::EntityCommon->new($self->{_io}, $self, $self->{_root});
    ...
    $self->{point_from} = CAD::Format::DWG::AC1001::Point2d->new($self->{_io}, $self, $self->{_root});
    ...
    $self->{flags} = CAD::Format::DWG::AC1001::AttrFlags->new($self->{_io}, $self, $self->{_root});
    ...
    if ($self->entity_common()->flag2_3()) {
        $self->{generation} = CAD::Format::DWG::AC1001::GenerationFlags->new($self->{_io}, $self, $self->{_root});
    }
    if ($self->entity_common()->flag2_2()) {
        $self->{horiz_alignment} = $self->{_io}->read_u1();
    }
    if ($self->entity_common()->flag2_1()) {
        $self->{aligned_to} = CAD::Format::DWG::AC1001::Point2d->new($self->{_io}, $self, $self->{_root});
    }
}
...
########################################################################
package CAD::Format::DWG::AC1001::LinetypeFlag;
...
########################################################################
package CAD::Format::DWG::AC1001::EntityTmp;
...
########################################################################
package CAD::Format::DWG::AC1001::BlockFlag;
...
########################################################################
package CAD::Format::DWG::AC1001::EntityLine3d;
...
########################################################################
package CAD::Format::DWG::AC1001::Pattern;
...
########################################################################
package CAD::Format::DWG::AC1001::EntityFace3d;
...
########################################################################
package CAD::Format::DWG::AC1001::EntitySolid;
...
sub _read {
    ...
    $self->{from} = CAD::Format::DWG::AC1001::Point2d->new($self->{_io}, $self, $self->{_root});
    $self->{from_and} = CAD::Format::DWG::AC1001::Point2d->new($self->{_io}, $self, $self->{_root});
    $self->{to} = CAD::Format::DWG::AC1001::Point2d->new($self->{_io}, $self, $self->{_root});
    $self->{to_and} = CAD::Format::DWG::AC1001::Point2d->new($self->{_io}, $self, $self->{_root});
}
...
########################################################################
package CAD::Format::DWG::AC1001::EntityInsert;
...
########################################################################
package CAD::Format::DWG::AC1001::Style;
...
sub _read {
    ...
    $self->{flag} = CAD::Format::DWG::AC1001::StyleFlag->new($self->{_io}, $self, $self->{_root});
...
########################################################################
package CAD::Format::DWG::AC1001::PolylineFlags;
...
########################################################################
package CAD::Format::DWG::AC1001::AttrFlags;
...
########################################################################
package CAD::Format::DWG::AC1001::EntityCommon;
...
########################################################################
package CAD::Format::DWG::AC1001::Linetype;
...
sub _read {
    ...
    $self->{flag} = CAD::Format::DWG::AC1001::LinetypeFlag->new($self->{_io}, $self, $self->{_root});
    ...
    $self->{pattern} = CAD::Format::DWG::AC1001::Pattern->new($self->{_io}, $self, $self->{_root});
...
########################################################################
package CAD::Format::DWG::AC1001::StyleFlag;
...
########################################################################
package CAD::Format::DWG::AC1001::Point3d;
...
########################################################################
package CAD::Format::DWG::AC1001::EntityBlockEnd;
...
########################################################################
package CAD::Format::DWG::AC1001::UnknownRepeating;
...
########################################################################
package CAD::Format::DWG::AC1001::Point2d;
...
########################################################################
package CAD::Format::DWG::AC1001::EntityPoint;
...
########################################################################
package CAD::Format::DWG::AC1001::AttdefFlags;
...
########################################################################
package CAD::Format::DWG::AC1001::ViewFlag;
...
########################################################################
package CAD::Format::DWG::AC1001::EntityTrace;
...
########################################################################
package CAD::Format::DWG::AC1001::Layer;
...
sub _read {
    ...
    $self->{flag} = CAD::Format::DWG::AC1001::LayerFlag->new($self->{_io}, $self, $self->{_root});
...
########################################################################
package CAD::Format::DWG::AC1001::Block;
...
sub _read {
    ...
    $self->{flag} = CAD::Format::DWG::AC1001::BlockFlag->new($self->{_io}, $self, $self->{_root});
...
########################################################################
package CAD::Format::DWG::AC1001::EntityText;
...
sub _read {
    ...
    $self->{insert_point} = CAD::Format::DWG::AC1001::Point2d->new($self->{_io}, $self, $self->{_root});
    $self->{height} = $self->{_io}->read_f8le();
...
########################################################################
package CAD::Format::DWG::AC1001::EntityJump;
...
########################################################################
package CAD::Format::DWG::AC1001::GenerationFlags;
...
########################################################################
package CAD::Format::DWG::AC1001::EntityAttdef;
...
sub _read {
    ...
    $self->{start_point} = CAD::Format::DWG::AC1001::Point2d->new($self->{_io}, $self, $self->{_root});
    $self->{height} = $self->{_io}->read_f8le();
    ...
    $self->{len_tag} = $self->{_io}->read_s2le();
    $self->{tag} = Encode::decode("ASCII", IO::KaitaiStruct::Stream::bytes_terminate($self->{_io}->read_bytes($self->len_tag()), 0, 0));
    $self->{flags} = CAD::Format::DWG::AC1001::AttdefFlags->new($self->{_io}, $self, $self->{_root});
    if ($self->entity_common()->flag2_7()) {
        $self->{rotation_angle_in_radians} = $self->{_io}->read_f8le();
    }
    if ($self->entity_common()->flag2_6()) {
    ...
    if ($self->entity_common()->flag2_1()) {
        $self->{end_point} = CAD::Format::DWG::AC1001::Point2d->new($self->{_io}, $self, $self->{_root});
    }
}
...
########################################################################
package CAD::Format::DWG::AC1001::EntityBlockBegin;
...
########################################################################
package CAD::Format::DWG::AC1001::EntityDim;
...
sub _read {
    ...
    $self->{entity_common} = CAD::Format::DWG::AC1001::EntityCommon->new($self->{_io}, $self, $self->{_root});
    $self->{block_index} = $self->{_io}->read_s2le();
    $self->{dimension_line_defining_point} = CAD::Format::DWG::AC1001::Point2d->new($self->{_io}, $self, $self->{_root});
    $self->{default_text_position} = CAD::Format::DWG::AC1001::Point2d->new($self->{_io}, $self, $self->{_root});
    if ($self->entity_common()->flag2_7()) {
        $self->{dim_type} = CAD::Format::DWG::AC1001::DimType->new($self->{_io}, $self, $self->{_root});
    }
    if ($self->entity_common()->flag2_6()) {
    ...
    if ($self->entity_common()->flag2_5()) {
        $self->{extension_defining_point1} = CAD::Format::DWG::AC1001::Point2d->new($self->{_io}, $self, $self->{_root});
    }
    if ($self->entity_common()->flag2_4()) {
        $self->{extension_defining_point2} = CAD::Format::DWG::AC1001::Point2d->new($self->{_io}, $self, $self->{_root});
    }
    if ($self->entity_common()->flag2_3()) {
        $self->{defining_point} = CAD::Format::DWG::AC1001::Point2d->new($self->{_io}, $self, $self->{_root});
    }
    if ($self->entity_common()->flag2_2()) {
        $self->{dimension_line_arc_definition_point} = CAD::Format::DWG::AC1001::Point2d->new($self->{_io}, $self, $self->{_root});
    }
...
########################################################################
package CAD::Format::DWG::AC1001::HeaderVariables;
...
sub _read {
    ...
    $self->{insertion_base} = CAD::Format::DWG::AC1001::Point3d->new($self->{_io}, $self, $self->{_root});
    $self->{num_entities} = $self->{_io}->read_u2le();
    $self->{drawing_first} = CAD::Format::DWG::AC1001::Point3d->new($self->{_io}, $self, $self->{_root});
    $self->{drawing_second} = CAD::Format::DWG::AC1001::Point3d->new($self->{_io}, $self, $self->{_root});
    $self->{limits_min} = CAD::Format::DWG::AC1001::Point2d->new($self->{_io}, $self, $self->{_root});
    $self->{limits_max} = CAD::Format::DWG::AC1001::Point2d->new($self->{_io}, $self, $self->{_root});
    $self->{view_ctrl} = CAD::Format::DWG::AC1001::Point3d->new($self->{_io}, $self, $self->{_root});
    $self->{view_size} = $self->{_io}->read_f8le();
    $self->{snap} = $self->{_io}->read_s2le();
    $self->{snap_resolution} = CAD::Format::DWG::AC1001::Point2d->new($self->{_io}, $self, $self->{_root});
    $self->{snap_base} = CAD::Format::DWG::AC1001::Point2d->new($self->{_io}, $self, $self->{_root});
    ...
    $self->{grid_unit} = CAD::Format::DWG::AC1001::Point2d->new($self->{_io}, $self, $self->{_root});
    ...
    $self->{axis_value} = CAD::Format::DWG::AC1001::Point2d->new($self->{_io}, $self, $self->{_root});
    ...
    $self->{view_dir} = CAD::Format::DWG::AC1001::Point3d->new($self->{_io}, $self, $self->{_root});
    $self->{view_point_x} = CAD::Format::DWG::AC1001::Point3d->new($self->{_io}, $self, $self->{_root});
    $self->{view_point_y} = CAD::Format::DWG::AC1001::Point3d->new($self->{_io}, $self, $self->{_root});
    $self->{view_point_z} = CAD::Format::DWG::AC1001::Point3d->new($self->{_io}, $self, $self->{_root});
    $self->{view_point_x_alt} = CAD::Format::DWG::AC1001::Point3d->new($self->{_io}, $self, $self->{_root});
    $self->{view_point_y_alt} = CAD::Format::DWG::AC1001::Point3d->new($self->{_io}, $self, $self->{_root});
    $self->{view_point_z_alt} = CAD::Format::DWG::AC1001::Point3d->new($self->{_io}, $self, $self->{_root});
...
########################################################################
package CAD::Format::DWG::AC1001::EntityArc;
...
########################################################################
package CAD::Format::DWG::AC1001::Entity;
...
sub _read {
    ...
    if ($_on == $CAD::Format::DWG::AC1001::ENTITIES_SOLID) {
        $self->{data} = CAD::Format::DWG::AC1001::EntitySolid->new($self->{_io}, $self, $self->{_root});
    }
    elsif ($_on == $CAD::Format::DWG::AC1001::ENTITIES_SHAPE) {
        $self->{data} = CAD::Format::DWG::AC1001::EntityShape->new($self->{_io}, $self, $self->{_root});
    }
    elsif ($_on == $CAD::Format::DWG::AC1001::ENTITIES_SEQEND) {
        $self->{data} = CAD::Format::DWG::AC1001::EntitySeqend->new($self->{_io}, $self, $self->{_root});
    }
    elsif ($_on == $CAD::Format::DWG::AC1001::ENTITIES_DIM) {
        $self->{data} = CAD::Format::DWG::AC1001::EntityDim->new($self->{_io}, $self, $self->{_root});
    }
    elsif ($_on == $CAD::Format::DWG::AC1001::ENTITIES_BLOCK_BEGIN) {
        $self->{data} = CAD::Format::DWG::AC1001::EntityBlockBegin->new($self->{_io}, $self, $self->{_root});
    }
    elsif ($_on == $CAD::Format::DWG::AC1001::ENTITIES_LINE) {
        $self->{data} = CAD::Format::DWG::AC1001::EntityLine->new($self->{_io}, $self, $self->{_root});
    }
    elsif ($_on == $CAD::Format::DWG::AC1001::ENTITIES_LINE3D) {
        $self->{data} = CAD::Format::DWG::AC1001::EntityLine3d->new($self->{_io}, $self, $self->{_root});
    }
    elsif ($_on == $CAD::Format::DWG::AC1001::ENTITIES_TEXT) {
        $self->{data} = CAD::Format::DWG::AC1001::EntityText->new($self->{_io}, $self, $self->{_root});
    }
    elsif ($_on == $CAD::Format::DWG::AC1001::ENTITIES_INSERT) {
        $self->{data} = CAD::Format::DWG::AC1001::EntityInsert->new($self->{_io}, $self, $self->{_root});
    }
    elsif ($_on == $CAD::Format::DWG::AC1001::ENTITIES_CIRCLE) {
        $self->{data} = CAD::Format::DWG::AC1001::EntityCircle->new($self->{_io}, $self, $self->{_root});
    }
    elsif ($_on == $CAD::Format::DWG::AC1001::ENTITIES_ARC) {
        $self->{data} = CAD::Format::DWG::AC1001::EntityArc->new($self->{_io}, $self, $self->{_root});
    }
    elsif ($_on == $CAD::Format::DWG::AC1001::ENTITIES_VERTEX) {
        $self->{data} = CAD::Format::DWG::AC1001::EntityVertex->new($self->{_io}, $self, $self->{_root});
    }
    ...
    elsif ($_on == $CAD::Format::DWG::AC1001::ENTITIES_JUMP) {
        $self->{data} = CAD::Format::DWG::AC1001::EntityJump->new($self->{_io}, $self, $self->{_root});
    }
    elsif ($_on == $CAD::Format::DWG::AC1001::ENTITIES_BLOCK_END) {
        $self->{data} = CAD::Format::DWG::AC1001::EntityBlockEnd->new($self->{_io}, $self, $self->{_root});
    }
    elsif ($_on == $CAD::Format::DWG::AC1001::ENTITIES_POINT) {
        $self->{data} = CAD::Format::DWG::AC1001::EntityPoint->new($self->{_io}, $self, $self->{_root});
    }
    elsif ($_on == $CAD::Format::DWG::AC1001::ENTITIES_TRACE) {
        $self->{data} = CAD::Format::DWG::AC1001::EntityTrace->new($self->{_io}, $self, $self->{_root});
    }
    elsif ($_on == $CAD::Format::DWG::AC1001::ENTITIES_POLYLINE) {
        $self->{data} = CAD::Format::DWG::AC1001::EntityPolyline->new($self->{_io}, $self, $self->{_root});
    }
    else {
        $self->{data} = CAD::Format::DWG::AC1001::EntityTmp->new($self->{_io}, $self, $self->{_root});
    }
}
...
########################################################################
package CAD::Format::DWG::AC1001::EntitySeqend;
...
########################################################################
package CAD::Format::DWG::AC1001::Header;
...
sub _read {
    ...
    $self->{table_block} = CAD::Format::DWG::AC1001::HeaderTable->new($self->{_io}, $self, $self->{_root});
    $self->{table_layer} = CAD::Format::DWG::AC1001::HeaderTable->new($self->{_io}, $self, $self->{_root});
    $self->{table_style} = CAD::Format::DWG::AC1001::HeaderTable->new($self->{_io}, $self, $self->{_root});
    $self->{table_linetype} = CAD::Format::DWG::AC1001::HeaderTable->new($self->{_io}, $self, $self->{_root});
    $self->{table_view} = CAD::Format::DWG::AC1001::HeaderTable->new($self->{_io}, $self, $self->{_root});
    $self->{variables} = CAD::Format::DWG::AC1001::HeaderVariables->new($self->{_io}, $self, $self->{_root});
}
...
########################################################################
package CAD::Format::DWG::AC1001::RealEntities;
...
sub _read {
    ...
    $self->{entities} = ();
    while (!$self->{_io}->is_eof()) {
        push @{$self->{entities}}, CAD::Format::DWG::AC1001::Entity->new($self->{_io}, $self, $self->{_root});
    }
}
...
########################################################################
package CAD::Format::DWG::AC1001::EntityCircle;
...
########################################################################
package CAD::Format::DWG::AC1001::EntityShape;
...
########################################################################
package CAD::Format::DWG::AC1001::EntityVertex;
...
########################################################################
package CAD::Format::DWG::AC1001::LayerFlag;
...
########################################################################
package CAD::Format::DWG::AC1001::EntityMode;
...
########################################################################
package CAD::Format::DWG::AC1001::EntityLine;
...
########################################################################
package CAD::Format::DWG::AC1001::DimType;
...
########################################################################
package CAD::Format::DWG::AC1001::EntityPolyline;
...
sub _read {
    ...
    if ($self->entity_common()->flag2_8()) {
        $self->{flag} = CAD::Format::DWG::AC1001::PolylineFlags->new($self->{_io}, $self, $self->{_root});
    }
    if ($self->entity_common()->flag2_7()) {
        $self->{start_width} = $self->{_io}->read_f8le();
    }
...
########################################################################
package CAD::Format::DWG::AC1001::View;
...
########################################################################
package CAD::Format::DWG::AC1001::HeaderTable;
