...
sub _read {
    ...
    $self->{table_block} = CAD::Format::DWG::AC1001::Table->new($self->{_io}, $self, $self->{_root});
    $self->{table_layer} = CAD::Format::DWG::AC1001::Table->new($self->{_io}, $self, $self->{_root});
    $self->{table_style} = CAD::Format::DWG::AC1001::Table->new($self->{_io}, $self, $self->{_root});
    $self->{table_linetype} = CAD::Format::DWG::AC1001::Table->new($self->{_io}, $self, $self->{_root});
    $self->{table_view} = CAD::Format::DWG::AC1001::Table->new($self->{_io}, $self, $self->{_root});
...
########################################################################
package CAD::Format::DWG::AC1001::Table;
